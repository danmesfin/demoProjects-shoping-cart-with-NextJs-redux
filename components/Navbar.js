...
export default function Navbar() {
  return (
    ...
    <div className="container"><Link href="index.html"><a className="navbar-brand d-inline-flex" ><Image className="d-inline-block" src="/favicon.ico" alt="logo" width={38} height={38} /><span className="text-1000 fs-0 fw-bold ms-2">Myshop</span></a></Link>
